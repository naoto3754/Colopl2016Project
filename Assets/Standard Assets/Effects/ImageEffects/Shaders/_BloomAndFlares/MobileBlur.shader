...
Shader "Hidden/FastBlur" {
	...
	CGINCLUDE
		...
		v2f_tap vert4Tap ( appdata_img v )
		{
			...
			o.uv21 = v.texcoord + _MainTex_TexelSize.xy * half2(-0.1h,-0.1h);	
			o.uv22 = v.texcoord + _MainTex_TexelSize.xy * half2(0.1h,-0.1h);		
			o.uv23 = v.texcoord + _MainTex_TexelSize.xy * half2(-0.1h,0.1h);		
