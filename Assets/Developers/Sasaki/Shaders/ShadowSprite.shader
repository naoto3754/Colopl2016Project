...
////// Emissive:
                ...
                float node_7811 = saturate(((attenuation*2.0)+(-1.0)));
                float node_603 = (_MainTex_var.a*_Color.a*i.vertexColor.a); // A
                float3 emissive = ((_MainTex_var.rgb*_Color.rgb*i.vertexColor.rgb*node_7811)*node_603);
